...
import { collectDiagnosticsBundle, listMigrations } from "@/lib/tauri-api";
...
function SettingsPage() {
  ...
  return (
    <main className="container mx-auto max-w-5xl space-y-6 p-6" data-testid="settings-page">
      <div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground text-sm">{t("settings.capabilitiesBody")}</p>
          <Button asChild>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap gap-3">
            <Button
              data-testid="collect-diagnostics"
          ...
          {bundle && (
            <div className="space-y-1 text-sm" data-testid="diagnostics-result">
              <p>
        ...
        <CardContent className="space-y-4">
          ...
          {migrationsQuery.data && migrationsQuery.data.length > 0 ? (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm" data-testid="migrations-table">
      ...
      <Card>
        ...
        <CardContent className="space-y-1 text-sm">
          ...
          <p>
            <span className="font-medium">{t("settings.updates")}</span>{" "}
            <span className="text-muted-foreground">{t("settings.updatesDisabled")}</span>
          </p>
        </CardContent>
      </Card>
    </main>
